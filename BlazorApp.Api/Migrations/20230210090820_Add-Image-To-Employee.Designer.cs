...
namespace BlazorApp.Api.Migrations
{
    ...
    [Migration("20230210090820_Add-Image-To-Employee")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BlazorApp.Shared.Domain.Country", b =>
                {
            ...
            modelBuilder.Entity("BlazorApp.Shared.Domain.Employee", b =>
                {
            ...
            modelBuilder.Entity("BlazorApp.Shared.Domain.JobCategory", b =>
                {
                    b.Property<int>("JobCategoryId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BlazorApp.Shared.Domain.Employee", b =>
                {
                    b.HasOne("BlazorApp.Shared.Domain.Country", "Country")
                        .WithMany()
                        .HasForeignKey("CountryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("BlazorApp.Shared.Domain.JobCategory", "JobCategory")
                        .WithMany()
